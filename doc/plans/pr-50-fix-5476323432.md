...
**Status:** implemented (W299-W307; tip `00d034c`): H1 adopt-files refresh (W299-W302), F1-F2 / N1-N2 (W303-W305), plans + IQ-refresh + README (W306-W307). Merge bar green: offline `--lib --bins` 610 passed / 0 failed / 1 ignored, clippy `-D warnings` clean, fmt clean.
